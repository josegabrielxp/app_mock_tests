import 'package:app_mock_tests/data/repositories/booking/booking_repository.dart';
import 'package:app_mock_tests/data/services/local/local_data_service.dart';
import 'package:app_mock_tests/domain/models/booking/booking.dart';
import 'package:app_mock_tests/domain/models/booking/booking_summary.dart';
  ...
  Future<void> _createDefaultBooking() async {
    if(_bookings.isEmpty){
      ...
      final activities = (await _localDataService.getActivities())
        .where((activities) => activities.destinationRef == destination.ref)
        .take(4)
        .toList();
